...
public class OrderMQMsgConfig {
     ...
     */
    @Bean
    public Queue recreateOrderReceiver() {
     ...
     */
    @Bean
    public Binding bindingExchangeScoreReceiverQueue() {
     ...
     */
    @Bean
    public Binding bindingExchangeReCreateOrderQueue() {
        return BindingBuilder.bind(recreateOrderReceiver()).to(transExchange()).with(ROUTE_NAME_TRANSACTION);
    }
}
